...
function coordinate_spaces(featDir)
    ...
    coordinate_space_entity(fullfile(featDir, 'stats', 'sqrt_varcope1.nii.gz'), 5, true);
    coordinate_space_entity(fullfile(featDir, 'stats', 'zstat1.nii.gz'), 6, true);
    coordinate_space_entity(fullfile(featDir, 'stats', 'tstat1.nii.gz'), 7, true);
    coordinate_space_entity(fullfile(featDir, 'thresh_zstat1.nii.gz'), 8, true);
end